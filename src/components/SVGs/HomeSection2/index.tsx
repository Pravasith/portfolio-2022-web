...
export const Blob2 = () => {
    ...
    >
      <defs>
        <Turbulence/>
        <clipPath id="clippath-xuio">
          <path fill="none" d="M-19 0H439V354H-19z"></path>
        </clipPath>
      </defs>
      <g filter="url(#displacementFilter)" clipPath="url(#clippath-xuio)">
        <path
        //   fill="#fefcbb"
                            fill="#ED1C24"
          d="M259.38 117.94s-3.32 15 9.21 21.16c12.53 6.16 13.51 15.35 11.25 21.26-2.26 5.91-2.4 10.12 6.77 18.7 9.16 8.58.1 16.29-6.02 24.34-6.12 8.06-3.9 31.17-40.29 34.68-36.39 3.5-53.25 10.51-82.1-6.65-28.84-17.16-45.81-31.42-39.54-44.78 6.26-13.36 22.73-25.9 20.04-47.48-2.69-21.57 1.47-30.01 22.69-32.62 21.22-2.61 20.8 10.62 38.98-.02 18.18-10.65 27.1-10.3 33.74-4.52 6.64 5.78 31.04-1.23 25.27 15.94z"
        ></path>
        <path
        //   fill="#fcee21"
                            fill="#FF6A52"
          d="M237.32 139.29s-1.91 9.7 5.3 13.68c7.21 3.99 7.77 9.93 6.47 13.75-1.3 3.83-1.38 6.54 3.89 12.09s.06 10.53-3.46 15.74c-3.52 5.21-2.24 20.16-23.17 22.43-20.93 2.27-30.63 6.8-47.22-4.3s-26.35-20.32-22.74-28.96 13.07-16.75 11.53-30.71c-1.55-13.95.84-19.41 13.05-21.1s11.96 6.87 22.42-.01c10.46-6.89 15.59-6.66 19.4-2.92s17.85-.79 14.54 10.31z"
        ></path>
      </g>
    </svg> 
}
